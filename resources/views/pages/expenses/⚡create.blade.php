...
new #[Title('New Receipt')] class extends Component {
    ...
    public function save(bool $andNew = false): void
    {
        $this->validate();
    ...
    {
        $this->save(andNew: false);
    }

    public function saveAndNew(): void
    {
        $this->save(andNew: true);
    }
...
@include('partials.expenses.receipt-form', [
    'formTitle' => __('New Receipt'),
    'formSubtitle' => __('Register a new expense receipt.'),
    'showSaveAndNew' => true,
])
